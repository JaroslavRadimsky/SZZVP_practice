...
11. Hlídáním posledního pohybu zobrazit notifikaci po 30 sekundách neaktivity.
12. Při stisku `Ukoncit a ulozit` uložit poslední vzorek, doplnit čas konce a přepočítat souhrn.
13. Vytvořit adapter pro seznam měření.
14. V detailu zobrazit souhrn a přepínatelný graf bez dlouhého seznamu vzorků.
15. Přidat sdílení CSV přes `ACTION_SEND`.
16. Přidat mazání měření z historie.
17. Doplnit unit test pro výpočet statistik.
...
- Notifikace při neaktivitě: `TrackingActivity.checkInactivityNotification()`.
...
6. nechat telefon 30 sekund bez pohybu a ověřit upozornění na neaktivitu,
7. klepnout na `Ukoncit a ulozit`,
8. otevřít detail a zkontrolovat statistiky, přepínání grafu a CSV sdílení,
9. smazat vybrané měření v historii.
